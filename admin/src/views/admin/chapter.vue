...
export default {
  ...
  methods: {
    ...
    updateCourse() {
      let _this = this;
      Loading.show();
      _this.$ajax.post(process.env.VUE_APP_SERVER+"/business/admin/chapter/edit", {
        id: _this.course.id,
    ...
    del(delId) {
      ...
      var id = delId;
      Loading.show();
      _this.$ajax.delete(process.env.VUE_APP_SERVER+"/business/admin/chapter/delete/" + id).then(deleteRes => {
        Loading.hide();
